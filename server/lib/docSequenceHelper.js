...
function getSuggestedDocFormat(rawName) {
...
function formatDocumentNumber({ prefix = 'SHRP-', padding_digits = 4, include_year = false, suffix = '', number = 1, year = new Date().getFullYear() }) {
